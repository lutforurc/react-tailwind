    ...
    <>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[600px]">
          ...
          <div className='space-y-5 py-20 px-10 md:py-0 md:px-0 flex flex-col justify-center text-center items-center md:text-left md:items-start'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit ab accusantium quaerat eum veniam tempora quos totam architecto in dignissimos</p>
             <button className='primary-btn bg-gray-900 hover:bg-primary hover:text-white duration-300'>Request for Quotes</button>
          </div>
          {/* Hero Image Section */}
          <div>
